...
import static com.example.mercury.messageActivity.rImage;
import static com.example.mercury.messageActivity.sImage;
...
public class MessagesAdapter extends RecyclerView.Adapter {
    ...
    class SenderViewHolder extends RecyclerView.ViewHolder {
        ...
        public SenderViewHolder(@NonNull View itemView) {
            ...
            circleImageView=itemView.findViewById(R.id.profile_icon);
            textMessage=itemView.findViewById(R.id.textMessages1);
        }
    }
    ...
    class ReceiverViewHolder extends RecyclerView.ViewHolder {
        ...
        public ReceiverViewHolder(@NonNull View itemView) {
            ...
            circleImageView=itemView.findViewById(R.id.profile_icon);
            textMessage=itemView.findViewById(R.id.textMessages2);
        }
    }
}
